...
$task_duration = getNakedInput($_POST['newTask__duration']);
$task_title = getNakedInput($_POST['newTask__title']);

if( empty($task_duration) || empty($task_title) || !isset($_POST['newTask__genres']) ){
...
try{
  ...
  $sql_task = 'INSERT INTO tasks(title, duration) VALUES(:title, :duration)';
  $params = [
    ':title' => $task_title,
